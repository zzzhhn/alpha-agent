...
const translations = {
  zh: {
    ...
    "alpha.backtest.title": "1 年长短因子回测（SPY 基准）",
    "alpha.backtest.subtitle": "pre-cache 37 只美股面板，top 30% 多 / bottom 30% 空，日频调仓，80/20 训练/测试划分",
  ...
  en: {
    ...
    "alpha.backtest.title": "1-Year Long-Short Factor Backtest (SPY benchmark)",
    "alpha.backtest.subtitle": "Pre-cached 37-ticker US panel, top 30% long / bottom 30% short, daily rebalance, 80/20 train/test split",
