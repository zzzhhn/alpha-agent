      ...
      {open
        ? createPortal(
            <span
              ...
              className="pointer-events-none z-[1000] whitespace-pre-line rounded-[2px] border border-tm-rule-2 bg-tm-bg-2 p-2 font-sans text-xs leading-5 text-tm-fg shadow-[var(--tm-shadow-floating)]"
            >
              {content}
            </span>,
            document.body,
