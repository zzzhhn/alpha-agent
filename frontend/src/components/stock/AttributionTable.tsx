...
export default function AttributionTable({
  ...
  return (
    <div className="space-y-2">
      <div className="flex items-center justify-end gap-2">
        {card.tier_flip_today ? (
          <span
            ...
            className="inline-flex items-center gap-1 rounded-[2px] border border-tm-warn/40 bg-tm-warn/10 px-2 py-0.5 font-tm-sans text-xs text-tm-warn"
          >
        ...
        <TmButton
          ...
          title={modeTip}
          className="rounded-[2px] border-tm-accent/40 bg-tm-accent/10 font-tm-sans text-xs text-tm-accent hover:bg-tm-accent/20"
        >
      ...
      {!icAvailable ? (
        <div className="rounded-[2px] border border-tm-rule bg-tm-bg-3/40 px-3 py-1.5 font-tm-sans text-xs leading-relaxed text-tm-muted">
