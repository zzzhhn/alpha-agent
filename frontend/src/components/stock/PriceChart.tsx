  ...
  return (
    <section className="rounded-[2px] border border-tm-rule bg-tm-bg-2 p-4">
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        {status === "ok" ? (
          <div className="inline-flex items-center gap-1.5 rounded-[2px] border border-tm-accent/30 bg-tm-accent/10 px-2.5 py-1 text-sm text-tm-accent">
      ...
      <div className="relative" style={{ width: "100%", height: 320 }}>
        ...
        <div
          ref={tooltipRef}
          className="pointer-events-none absolute z-10 hidden max-w-[240px] rounded-[2px] border border-tm-rule bg-tm-bg-2/95 px-2 py-1.5 font-tm-sans text-xs leading-snug text-tm-fg shadow-[var(--tm-shadow-floating)]"
        />
        {status !== "ok" ? (
