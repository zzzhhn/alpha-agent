...
def create_app() -> FastAPI:
    ...
    def _import_cron_routes():
        from alpha_agent.api.routes.cron_routes import router
        return router
    ...
    def _import_news_enrich():
        from alpha_agent.api.routes.news_enrich import router
        return router
